...
export function LocateIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function LogoMark({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M29 3l-3 4" />
      <path d="M26 7c3 3 3 8.8-1.4 13.1l-6.3 6.3c-4.3 4.3-10.1 4.3-13.1 1.4-3-3-3-8.8 1.4-13.1l6.3-6.3c4.3-4.3 10.1-4.3 13.1-1.4z" />
      <circle cx="13.2" cy="19.8" r="4.2" />
      <circle cx="13.2" cy="17.6" r="0.35" fill="currentColor" />
      <circle cx="11" cy="19.8" r="0.35" fill="currentColor" />
      <circle cx="15.4" cy="19.8" r="0.35" fill="currentColor" />
      <circle cx="13.2" cy="22" r="0.35" fill="currentColor" />
      <circle cx="11.6" cy="18.2" r="0.35" fill="currentColor" />
      <circle cx="14.8" cy="21.4" r="0.35" fill="currentColor" />
    </svg>
  );
}
